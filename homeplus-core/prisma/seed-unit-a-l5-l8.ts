...
async function seedLesson6() {
  ...
  const questions = [
    ...
    ], correctAnswer: 'b', explanation: 'Succession is the natural, gradual process of ecosystem change — from bare ground to a mature community.', outcomeCode: 'SCI.7.A.K.3', difficulty: 1 },
    ...
    ], correctAnswer: 'b', explanation: 'Purple loosestrife was brought from Europe and aggressively outcompetes native wetland plants. The other examples are native Canadian species.', outcomeCode: 'SCI.7.A.K.3', difficulty: 1 },
    { id: 'l6-q3', questionText: 'What is the MAIN difference between primary and secondary succession?', questionType: 'MULTIPLE_CHOICE' as const, options: [
      ...
      { label: 'There is no difference', value: 'd' },
    ], correctAnswer: 'a', explanation: 'Primary succession begins on bare rock or lava (no soil exists). Secondary succession begins after a disturbance like fire or flood where soil remains.', outcomeCode: 'SCI.7.A.K.3', difficulty: 2 },
    ...
    ], correctAnswer: 'b', explanation: 'Fertilizer causes algal blooms (eutrophication). When algae die, bacteria decompose them and use up dissolved oxygen, suffocating fish.', outcomeCode: 'SCI.7.A.K.3', difficulty: 2 },
    ...
    ], correctAnswer: 'b', explanation: 'Clearing a forest for construction destroys the habitat where organisms live. This is habitat loss — one of the biggest threats to biodiversity.', outcomeCode: 'SCI.7.A.K.3', difficulty: 1 },
    ...
    ], correctAnswer: 'b', explanation: 'Some pine and eucalyptus species need fire to open their cones and release seeds. Fire also clears undergrowth and recycles nutrients.', outcomeCode: 'SCI.7.A.K.3', difficulty: 2 },
    ...
    ], correctAnswer: 'b', explanation: 'Without natural predators or diseases, invasive species reproduce rapidly and outcompete native species for food and habitat.', outcomeCode: 'SCI.7.A.K.3', difficulty: 1 },
    ...
    ], correctAnswer: 'b', explanation: 'Rainforest clearing (deforestation) directly destroys the most biodiverse ecosystems on Earth, eliminating thousands of species.', outcomeCode: 'SCI.7.A.K.3', difficulty: 1 },
    ...
    ], correctAnswer: 'b', explanation: 'Primary succession starts with pioneer species like lichens and mosses that can grow on bare rock. They break down rock into soil over many years.', outcomeCode: 'SCI.7.A.K.3', difficulty: 2 },
    ...
    ], correctAnswer: 'b', explanation: 'Fire is a local disturbance that ecosystems can recover from through succession. Climate change alters temperature and weather globally, changing conditions for all ecosystems simultaneously.', outcomeCode: 'SCI.7.A.K.3', difficulty: 2 },
  ];
...
async function seedLesson7() {
  ...
  const questions = [
    ...
    ], correctAnswer: 'b', explanation: 'Indicator species are sensitive to environmental changes, so their health tells us about the health of the whole ecosystem.', outcomeCode: 'SCI.7.A.K.3', difficulty: 1 },
    ...
    ], correctAnswer: 'b', explanation: 'Frogs absorb water and chemicals through their skin. Pollutants in water directly affect their health, making them early-warning systems for contamination.', outcomeCode: 'SCI.7.A.K.3', difficulty: 2 },
    ...
    ], correctAnswer: 'b', explanation: 'Mayfly larvae can only survive in clean, oxygen-rich water. Their presence is a strong positive indicator of water quality.', outcomeCode: 'SCI.7.A.K.3', difficulty: 1 },
    ...
    ], correctAnswer: 'b', explanation: 'Together, biotic and abiotic data give a complete picture — you can see both what is happening to organisms AND what environmental conditions might be causing it.', outcomeCode: 'SCI.7.A.K.3', difficulty: 2 },
    ...
    ], correctAnswer: 'b', explanation: 'Citizen science involves everyday people collecting scientific data. Students counting butterflies or birdwatchers reporting sightings are examples.', outcomeCode: 'SCI.7.A.K.3', difficulty: 1 },
    ...
    ], correctAnswer: 'b', explanation: 'Tubifex worms thrive in polluted, low-oxygen water. Finding them in large numbers near a factory is a red flag for water contamination.', outcomeCode: 'SCI.7.A.K.3', difficulty: 1 },
    ...
    ], correctAnswer: 'b', explanation: 'Lichens absorb nutrients directly from the air. They are very sensitive to air pollution — their disappearance is a strong indicator of poor air quality.', outcomeCode: 'SCI.7.A.K.3', difficulty: 2 },
    ...
    ], correctAnswer: 'b', explanation: 'Satellite imagery shows changes in land use, vegetation cover, and habitat loss over time — making it perfect for tracking long-term ecosystem changes.', outcomeCode: 'SCI.7.A.K.3', difficulty: 2 },
    ...
    ], correctAnswer: 'b', explanation: 'A biodiversity index tells you how many different species live in an area and how evenly they are distributed. Higher = healthier.', outcomeCode: 'SCI.7.A.K.3', difficulty: 1 },
    ...
    ], correctAnswer: 'b', explanation: 'Frogs, dragonflies, and fish need clean water. Tubifex worms thrive in polluted water. This shift in indicator species shows the lake has been severely degraded.', outcomeCode: 'SCI.7.A.K.3', difficulty: 2 },
  ];
...
async function seedLesson8() {
  ...
  const questions = [
    ...
    ], correctAnswer: 'b', explanation: 'Conservation means actively protecting and managing ecosystems so they can remain healthy for current and future generations.', outcomeCode: 'SCI.7.A.K.4', difficulty: 1 },
    ...
    ], correctAnswer: 'b', explanation: 'Stewardship means balancing human needs with environmental responsibility. Assessing impact, considering alternatives, and including restoration shows responsible decision-making.', outcomeCode: 'SCI.7.A.K.4', difficulty: 2 },
    ...
    ], correctAnswer: 'b', explanation: 'Sustainability is about balance — using resources wisely so that future generations can still benefit from healthy ecosystems.', outcomeCode: 'SCI.7.A.K.4', difficulty: 1 },
    ...
    ], correctAnswer: 'b', explanation: 'Protection of remaining habitat + restoration of degraded areas is the most effective approach. This preserves biodiversity while allowing some land for agriculture.', outcomeCode: 'SCI.7.A.K.4', difficulty: 2 },
    ...
    ], correctAnswer: 'b', explanation: 'Restoration means actively repairing damaged ecosystems — replanting native species, cleaning pollution, or rebuilding habitats.', outcomeCode: 'SCI.7.A.K.4', difficulty: 1 },
    ...
    ], correctAnswer: 'b', explanation: 'Humans are PART of ecosystems. We depend on them for air, water, food, medicines, and climate regulation. Destroying ecosystems ultimately harms humans too.', outcomeCode: 'SCI.7.A.K.4', difficulty: 2 },
    ...
    ], correctAnswer: 'a', explanation: 'Stewardship means taking personal action. Organizing a cleanup AND reporting observations (citizen science) is a practical way students can contribute.', outcomeCode: 'SCI.7.A.K.4', difficulty: 1 },
    ...
    ], correctAnswer: 'b', explanation: 'Selective logging keeps most of the forest intact — wildlife still has habitat, food webs remain functional, and seeds from remaining trees can regenerate the harvested areas.', outcomeCode: 'SCI.7.A.K.4', difficulty: 2 },
    ...
    ], correctAnswer: 'b', explanation: 'This is the central message of Unit A: ecosystems are complex, interconnected systems that ALL life depends on. Protecting them is protecting ourselves.', outcomeCode: 'SCI.7.A.K.4', difficulty: 2 },
    ...
    ], correctAnswer: 'b', explanation: 'Conservation requires ongoing monitoring and adaptation. Protection alone may not be enough — scientists must investigate root causes and update their strategies (adaptive management).', outcomeCode: 'SCI.7.A.K.4', difficulty: 2 },
  ];
