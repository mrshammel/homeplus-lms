...
//
// Mapping applied:
//   ELA.6.1 (inference/explicit/implicit) → ELA.6.RC.1
//   ELA.6.1 (text-to-self connection)     → ELA.6.RC.2
//   ELA.6.1 (figurative language)         → ELA.6.VL.2
//   ELA.6.1 (pronoun-antecedent/grammar)  → ELA.6.CV.3
//   ELA.6.2 (context clues)               → ELA.6.VL.3
//   ELA.6.2 (connotation)                 → ELA.6.VL.3
//   ELA.6.2 (figurative language/metaphor)→ ELA.6.VL.2
//   ELA.6.2 (prefix/morphology)           → ELA.6.VL.1
//   ELA.6.2 (semicolons)                  → ELA.6.CV.2
